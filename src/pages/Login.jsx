...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("https://ayi-backend.onrender.com/api/user/login", {
        method: "POST",
  ...
  const handlePasswordReset = async (e) => {
    ...
    try {
      const response = await fetch("https://ayi-backend.onrender.com/api/auth/forgot-password", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
