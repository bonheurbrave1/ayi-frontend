...
import { FaUsers, FaRocket, FaRegHandPointUp, FaWallet, FaComments, FaThumbsUp } from "react-icons/fa"; // Icons
...
const AccountPage = () => {
  ...
  return (
    <div className="font-sans bg-gray-900 text-white min-h-screen">
      ...
      <div className="py-10">
        <h2 className="text-3xl font-bold text-center mb-8">Manage Your Account</h2>

        <h1 className="text-center font-thin text-xl">Select - Click and continue</h1>
